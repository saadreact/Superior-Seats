...
// 3D Scene component wrapped in Suspense
function Scene3D({ selectedTexture, selectedColor, currentObjectIndex }: Chair3DModelProps) {
  const currentChair = chairTypes[currentObjectIndex];

  return (
    <Canvas
      key={`canvas-${currentObjectIndex}`}
