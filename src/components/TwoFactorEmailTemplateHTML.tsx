...
interface TwoFactorEmailTemplateHTMLProps {
  onBack: () => void;
}
...
const TwoFactorEmailTemplateHTML: React.FC<TwoFactorEmailTemplateHTMLProps> = ({ onBack }) => {
...
<head>
    ...
    <title>Two-Factor Authentication - Superior Seats</title>
    <!--[if mso]>
    <noscript>
        <xml>
                    ...
                    <table class="email-container" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600">
                        ...
                        <tr>
                            <td class="header">
                                ...
                                <div class="header-title">Two-Factor Authentication Code</div>
                            </td>
                        </tr>
        ...
        >
          <Box sx={{ p: 3, backgroundColor: '#f8f9fa', borderBottom: '1px solid #e9ecef' }}>
            <Typography variant="h6" sx={{ color: '#d32f2f', fontWeight: 'bold' }}>
              HTML Email Template - Two-Factor Authentication
            </Typography>
...
export default TwoFactorEmailTemplateHTML;
