 ...
 */
export const createBrisaDistressedMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 12.0, specularIntensity = 0.25) => {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Material-specific specular (Brisa distressed worn/matte)
