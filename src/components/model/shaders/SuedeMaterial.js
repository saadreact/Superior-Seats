 ...
 */
export const createSuedeMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 8.0, specularIntensity = 0.15, isTwoTone = false, noStitching = false) => {
 ...
 */
export const updateSuedeUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
