 ...
 */
export const createCarbonFiberMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 48.0, specularIntensity = 0.7, isTwoTone = false, noStitching = false) => {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Material-specific specular (carbon fiber is very glossy)
 ...
 */
export const updateCarbonFiberUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
