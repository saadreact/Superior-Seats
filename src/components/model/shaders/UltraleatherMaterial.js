 ...
 */
export const createUltraleatherMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 22.0, specularIntensity = 0.45, isTwoTone = false, noStitching = false, externalStitchColor = null) => {
  // ✅ Load fine-grain procedural bump texture for extra realism
  const leatherGrainTexture = new THREE.TextureLoader().load('/assets/fabrics/UltraLeather.png');
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // ✅ Enhanced fabric texture visibility for ultra leather
      ...
      // Enhanced specular with texture-based variation
 ...
 */
export const updateUltraleatherUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity, externalStitchColor = null) => {
