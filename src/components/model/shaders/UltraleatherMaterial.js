 ...
 */
export const createUltraleatherMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 22.0, specularIntensity = 0.45, isTwoTone = false, noStitching = false) => {
 ...
 */
export const updateUltraleatherUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
