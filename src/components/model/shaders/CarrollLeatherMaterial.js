 ...
 */
export const createCarrollLeatherMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 18.0, specularIntensity = 0.35, isTwoTone = false, noStitching = false) => {
 ...
 */
export const updateCarrollLeatherUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
