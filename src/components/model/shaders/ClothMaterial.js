 ...
 */
export const createClothMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 6.0, specularIntensity = 0.1, isTwoTone = false, noStitching = false) => {
 ...
 */
export const updateClothUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
