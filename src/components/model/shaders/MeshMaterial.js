 ...
 */
export const createMeshMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 10.0, specularIntensity = 0.2, isTwoTone = false, noStitching = false) => {
 ...
 */
export const updateMeshUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity) => {
