 ...
 */
export const createMiamiVinylMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 28.0, specularIntensity = 0.55) => {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Material-specific specular (Miami vinyl semi-gloss)
