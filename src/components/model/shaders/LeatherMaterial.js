  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      if (fabricLuminance < 0.15) {
        // Boost brightness for dark colors to maintain pattern visibility
      ...
      // Material-specific specular with grain variation (added AFTER boost)
      ...
      // Combine boosted diffuse with natural specular
