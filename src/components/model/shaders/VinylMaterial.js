 ...
 */
export const createVinylMaterial = (fabricColor, stitchColor, textures, ambientStrength = 0.5, specularPower = 32.0, specularIntensity = 0.6, isTwoTone = false, noStitching = false, externalStitchColor = null) => {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Material-specific specular (vinyl is shiny) - added AFTER boost
 ...
 */
export const updateVinylUniforms = (material, fabricColor, stitchColor, ambientStrength, specularPower, specularIntensity, externalStitchColor = null) => {
