...
const HeroSection = () => {
  ...
  const [slideDirection, setSlideDirection] = React.useState<"right" | "left">(
    "left"
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <source
            src={`${process.env.NEXT_PUBLIC_API_VIDEO_BASE_URL}/videos/SuperiorSeatingLLC_WebsiteBannerVideo.mov`}
            type="video/mp4"
          />
          <source
            src={`${process.env.NEXT_PUBLIC_API_VIDEO_BASE_URL}/videos/SuperiorSeatingLLC_WebsiteBannerVideo.mov`}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Premium Truck, SemiTruck, RV and Van seating
      ...
      >
        <motion.div
          ...
          animate={{
            width: `${Math.round(
              Math.min(100, Math.max(0, videoProgress * 100))
            )}%`,
          }}
